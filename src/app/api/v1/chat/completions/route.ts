...
export async function POST(req: NextRequest) {
  ...
  const MODEL_ALIASES: Record<string, string> = {
    // Claude → OpenRouter (Anthropic SSH tunnel dead, OpenRouter tunnel via Bandwagon works)
    // Note: short model name only - OpenRouter adapter's modelMap handles full slug mapping
    "claude-sonnet-5": "openrouter/claude-sonnet-5",
    "claude-sonnet-4-6": "openrouter/claude-sonnet-4-6",
    "claude-sonnet-4.6": "openrouter/claude-sonnet-4-6",
    "claude-sonnet-4-20250514": "openrouter/claude-sonnet-5",
    ...
    "claude-opus-4": "openrouter/claude-opus-4-8",
    "claude-haiku-4-5": "openrouter/claude-haiku-4-5-20251001",
    "claude-haiku-4": "openrouter/claude-haiku-4-5",
    "claude-fable-5": "openrouter/claude-fable-5",
    "claude-3.5-sonnet": "openrouter/claude-sonnet-4-5-20250929",
    "claude-3.5-haiku": "openrouter/claude-haiku-4-5-20251001",
    "claude-3-opus": "openrouter/claude-opus-4-1-20250805",
    "claude-sonnet-4-5": "openrouter/claude-sonnet-4-5-20250929",
    // OpenAI → OpenRouter too (same proxy issue)
    "gpt-4o": "openrouter/gpt-4o",
    "gpt-5": "openrouter/gpt-5",
    // Chinese providers — direct (no geo-block), map model names to internal slugs
    ...
    "qwen-max": "qwen/qwen-plus",
    "qwen-max-latest": "qwen/qwen-plus",
    "qwen-turbo": "qwen/qwen-plus",
    "glm-4": "glm/glm-4-flash",
    "glm-4-flash": "glm/glm-4-flash",
    "glm-4.7": "glm/glm-4.7-flash",
    "glm-4.7-flash": "glm/glm-4.7-flash",
    "glm-4-plus": "glm/glm-4-flash",
    "kimi": "moonshot/kimi-k3",
    "kimi-k3": "moonshot/kimi-k3",
    "moonshot": "moonshot/kimi-k3",
    "moonshot-v1": "moonshot/kimi-k3",
    "moonshot-v1-8k": "moonshot/kimi-k3",
    // DanteCloud
    "doubao-pro": "doubao/doubao-seed-2-1-pro",
    "doubao-seed": "doubao/doubao-seed-2-1-pro",
    // Wenxin / ERNIE
    "ernie-4": "wenxin/ernie-4.0-turbo",
    "ernie-4-turbo": "wenxin/ernie-4.0-turbo",
  };
