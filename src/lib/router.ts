...
const FALLBACK_RULES = [
  ...
  { intent: "creative", keywords: "故事,写文章,剧本,创意,角色扮演,小说,诗歌,文案,广告语", targetModel: "openrouter/claude-sonnet-5", priority: 10, candidates: ["openrouter/claude-sonnet-5", "moonshot/kimi-k3", "qwen/qwen-plus"] },
