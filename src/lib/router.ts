...
const FALLBACK_RULES = [
  { intent: "code", keywords: "代码,函数,bug,算法,实现,编程,import,class,function,code,fix,implement,typescript,python,rust,react,组件", targetModel: "deepseek/deepseek-v4-pro", priority: 10 },
  ...
  { intent: "reasoning", keywords: "推理,分析,逻辑,思考,为什么,how to,数学,证明,论证", targetModel: "deepseek/deepseek-v4-pro", priority: 10 },
];
